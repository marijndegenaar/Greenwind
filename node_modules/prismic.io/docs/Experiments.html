...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Experiments</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Experiments</h1>
...
<article>
    ...
    <h4 class="name" id="Experiments"><span class="type-signature"></span>new Experiments<span class="signature">(data)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="description last">the json data received from the Prismic API</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="experiments.js.html">experiments.js</a>, <a href="experiments.js.html#line9">line 9</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="refFromCookie"><span class="type-signature"></span>refFromCookie<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="experiments.js.html">experiments.js</a>, <a href="experiments.js.html#line31">line 31</a>
    </li></ul></dd>
